...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        self.entity_list.extend(code.entityFactory.EntityFactory.get_entity(self.name + 'Bg'))
        player = code.entityFactory.EntityFactory.get_entity('Player1')
        player.score = player_score[0]
        self.entity_list.append(player)
        if game_mode in [MENU_OPTION[1], MENU_OPTION[2]]:
            player = code.entityFactory.EntityFactory.get_entity('Player2')
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == EVENT_ENEMY:
                    ...
                    self.entity_list.append(code.entityFactory.EntityFactory.get_entity(choice))
